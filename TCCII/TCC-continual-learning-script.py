...
index = 0
while index < 500:
    retrain_question = new_data_questions[index]
    retrain_answer = new_data_answers[index]
    index += 1
    
    precision, retrain_loss = chat_auto.chat(retrain_question, retrain_answer, print_info=False)
